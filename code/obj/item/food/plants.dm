...
/obj/item/reagent_containers/food/snacks/plant/orange/
	...
	attackby(obj/item/W as obj, mob/user as mob)
		if (istype(W, /obj/item/reagent_containers/food/snacks/ingredient/meat/synthmeat))
			...
			qdel(W)
			qdel(src)
		else if ((istype(W, /obj/item/axe) || isscalpel(W) || istype(W, /obj/item/sword) || ((isssaw(W)) && !(istype(W, /obj/item/kitchen/utensil/fork)))) && !istype (src, /obj/item/reagent_containers/food/snacks/plant/orange/wedge))
...
/obj/item/reagent_containers/food/snacks/plant/melon/
	...
	attackby(obj/item/W as obj, mob/user as mob)
		if (istype(W, /obj/item/axe) || isscalpel(W) || istype(W, /obj/item/sword) || ((isssaw(W)) && !(istype(W, /obj/item/kitchen/utensil/fork))))
			var/turf/T = get_turf(src)
			user.visible_message("[user] cuts [src] into slices.", "You cut [src] into slices.")
			var/makeslices = 6
			while (makeslices > 0)
