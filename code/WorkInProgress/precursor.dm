...
/obj/critter/shade
	...
	CritterAttack(mob/M)
		...
		if (M.lying)
			src.speak( pick("me-àm ina men-an-uras-a?", "e-zé ina gu-sum... e-zé ina gú-ri-ta!", "e-zé ní-gig, e-zé ní-dím-dím-ma, e-zé u...bar ina libir lugar!", "namlugallu-zu-ne-ne inim-dirig, namgallu-zu-ne-ne inim-búr-ra, izi te-en ina an!", "ri azag, ri azag, ri azag, ri érim, ri e-zé!", "e-zé, érim diir-da...nu-me-a.") )
	...
	ai_think()
		if(task == "thinking" || task == "wandering")
			if (prob(5))
				src.speak( pick("namlugallu ha-lam ina lugal-aà-lá-sù...","ù da-rí-sè e...","á-e-me-en ìri-zé-er igi-bad!","inim...kí ina ki-dul, ina e-ùr, ina ki-bad-rá, hé-àm-me-àm...", "ìri-kúr...díb, ìri...ar, e-zé...", "galam, gamar ganzer, gíbil píri! ul, ul! súkud...") )
			...
			if (prob(5))
				src.speak( pick("ina urudu e-re-sì-ki-in kala libir arza ina SÚKUD ZAL.", "i.menden ina nam-ab-ba issa, nam-nu-tar  nam-diir, i.menden lúní-áa...","bar...gub ina bàd-ul-hi...","idim ak ina libir igal, diir ak ina agrun, ul-ár-ra, zà-mí!", "ùru pàd gíg, ina gidim niin!") )
	...
	CritterDeath()
		speak( pick("ìr...áa ina ìr-kug záh-bi!", "éd, èd, u...bar...", "ní-nam-nu-kal...", "lugal-me taru, lugal-me galam!", "me-li-e-a...") )
	...
	seek_target()
		...
		for (var/mob/living/carbon/C in view(src.seekrange,src))
			...
			src.task = "chasing"
			src.speak( pick("siskur, siskur ina na sukkal...","ára ina gíg, ú ina ur zal...","lú-érim! lú-érim!","á á-zi-ga...bal, na, e-zé ha-lam ina é si-ga...") )
